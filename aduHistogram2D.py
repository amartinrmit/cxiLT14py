...
if atp.args.pixelMask2 != "None":
    ipmask2 = np.load( atp.args.pixelMask2 )
    pflag2 = True
    #ipmask = np.where( pmask == 1.0 )
    ipmask2 = ( ipmask2[0], ipmask2[1], ipmask2[2])
    ...
    print outname
    at.io.saveImage( atp.args, assembledmask, "pixelmask2", prog=atp.parser.prog, outname=outname )   
